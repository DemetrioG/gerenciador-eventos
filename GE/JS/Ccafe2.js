...
document.addEventListener('DOMContentLoaded', function(){
    ...
    //mostrarErro()
    document.getElementById("btn35").onclick = erroNome;
    
});

//Verif se há texto na caixa
function textoValido(cafe2){
    if (cafe2 == null || cafe2 == "" || cafe2.lenght < 1) {
        return false;
    }else{
        return true;
    }
...
function mostrarErro(){
    ...
    document.getElementById('erro_Ccafe2').innerHTML = html;
}

//Limpar caixa de erro 
function limparErro(){
    document.getElementById('erro_Ccafe2').innerHTML = "";  
}

//Verificar erro nome
function erroNome(){
    var conteudoNome = document.getElementById('cafe2').value;
...
function mostrarCafe(){
    ...
    lista_cafe = []
    let menu
    menu = document.getElementById('cafe2').value
